      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            {(candidate.proudAchievement || candidate.biggestStrength || candidate.biggestWeakness) && (
              <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <h2 className="mb-3 text-lg font-semibold text-gray-900">Highlights & Growth Areas</h2>
                <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
                  {candidate.proudAchievement && (
                    <p><span className="font-medium text-gray-900">Proud Achievement:</span> {candidate.proudAchievement}</p>
                  )}
